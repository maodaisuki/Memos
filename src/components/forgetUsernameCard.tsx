'use client'
import { ForgetUsername } from "@/api/email";
import { useState } from "react";

const ForgetUsernameCard = () => {
    ...
    const sendEmail = async () => {
        ...
        const { data, error } = await ForgetUsername(email);
        if (data == null) {
            setIsEmailError(true);
            setIsLoading(false);
            return;
...
export default ForgetUsernameCard;